CLASS zrap110_calc_book_elem_THO DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrap110_calc_book_elem_THO IMPLEMENTATION.
    ...
    LOOP AT it_requested_calc_elements ASSIGNING FIELD-SYMBOL(<fs_req_calc_elements>).
      CASE <fs_req_calc_elements>.
        ...
        WHEN 'INITIALDAYSTOFLIGHT'   OR 'REMAININGDAYSTOFLIGHT'
          ...
          DATA lt_book_original_data TYPE STANDARD TABLE OF ZRAP110_C_BookingTP_THO WITH DEFAULT KEY.
          ...
          LOOP AT lt_book_original_data ASSIGNING FIELD-SYMBOL(<fs_book_original_data>).
            ...
            <fs_book_original_data> = zrap110_calc_book_elem_tho=>calculate_days_to_flight( <fs_book_original_data> ).
  ...
  METHOD if_sadl_exit_calc_element_read~get_calculation_info.
    IF iv_entity EQ 'ZRAP110_C_BOOKINGTP_THO'. "Booking BO node
